...
@Getter
public abstract class BaseModelExtension extends Model implements ModelExtension {
  ...
  public synchronized void applyParent(ExtendedModel parent) {
    BaseModelExtension parentObj = parent.getExtension(AddonLoaderTypes.BASIC_SPLIT);
